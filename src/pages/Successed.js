const Successed = () => {
  return (
    <div className="w-full relative bg-gray1-200 h-[1283px] overflow-hidden text-right text-sm text-light-grey font-gotham-book">
      ...
      <div className="absolute top-[273px] left-[1516px] w-[9px] h-[901px]">
        <div className="absolute top-[0px] left-[0px] rounded-sm bg-row w-[9px] h-[901px]" />
        <div className="absolute top-[0px] left-[0px] rounded-sm bg-pale-purple w-[9px] h-[73px]" />
      </div>
      <div className="absolute top-[calc(50%_-_283.5px)] left-[calc(50%_-_322px)] rounded-lg bg-main-dark [backdrop-filter:blur(24px)] box-border w-[644px] overflow-hidden flex flex-col items-center justify-start p-10 gap-[24px] text-center text-5xl border-[1px] border-solid border-darkslategray-100">
        <div className="w-[381.1px] absolute my-0 mx-[!important] top-[110px] left-[363.9px] rounded-[50%] [background:linear-gradient(136.23deg,_#027fff,_rgba(83,_2,_255,_0))] [filter:blur(160px)] h-[549.7px] [transform:_rotate(29.29deg)] [transform-origin:0_0] opacity-[0.2] z-[0]" />
        <div className="self-stretch h-[70px] flex flex-col items-center justify-start gap-[16px] z-[1] text-white">
          <img
            className="w-[200px] relative h-[25.5px]"
            alt=""
            src="/group.svg"
          />
          <div className="self-stretch flex flex-col items-center justify-start">
            <div className="self-stretch relative">
              Just Lent NFT fractions on Dissect!
            </div>
          </div>
          <div className="self-stretch" />
        </div>
        <div className="flex flex-col items-center justify-start gap-[8px] z-[2] text-right font-h1-title-42">
          <div className="h-[176.9px] flex flex-col items-center justify-center gap-[8px]">
            ...
            />
            <div className="relative">Mad Lads</div>
          </div>
          <div className="self-stretch flex flex-row items-center justify-between text-center text-sm text-silver font-medium">
            ...
            <div className="h-6 flex flex-row items-center justify-start gap-[8px] text-base text-mid-grey font-gotham-book">
        ...
        <div className="flex flex-row items-center justify-center pt-6 px-0 pb-0 gap-[32px] z-[3] text-sm text-mid-grey">
          <div className="w-[100px] flex flex-col items-center justify-start gap-[8px]">
            <div className="self-stretch relative">Collection</div>
            <div className="self-stretch relative text-base text-white">
              Mad Lads
            </div>
          </div>
          <div className="w-[0.5px] relative box-border h-[30.5px] border-r-[0.5px] border-solid border-pale-purple" />
          <div className="w-[100px] flex flex-col items-center justify-start gap-[8px]">
            <div className="self-stretch relative">Pool ID</div>
            <div className="self-stretch relative text-base text-white">
              QrpttD
            </div>
          </div>
          <div className="w-[0.5px] relative box-border h-[30.5px] hidden border-r-[0.5px] border-solid border-pale-purple" />
          <div className="w-[100px] hidden flex-col items-center justify-start gap-[8px]">
            <div className="self-stretch relative">Referral Code</div>
            <div className="self-stretch relative text-base text-white">
              2Y15Bx
            </div>
          </div>
        </div>
        <div className="flex flex-col items-center justify-start py-4 px-0 z-[4] text-base">
          <div className="flex flex-row items-start justify-center gap-[24px]">
            <div className="rounded box-border h-11 flex flex-row items-center justify-center p-2.5 gap-[8px] min-w-[144px] border-[1px] border-solid border-mid-grey">
              <div className="relative">Copy</div>
              <img
                className="w-6 relative h-6"
                alt=""
                src="/property-1copy-selectedon.svg"
              />
            </div>
            <div className="rounded box-border h-11 flex flex-row items-center justify-center p-2.5 gap-[8px] min-w-[144px] border-[1px] border-solid border-mid-grey">
        ...
        <div className="w-[376px] hidden flex-col items-center justify-start gap-[24px] z-[5] text-base">
          <div className="w-[376px] rounded box-border h-11 hidden flex-row items-center justify-center p-2.5 gap-[8px] min-w-[144px] border-[1px] border-solid border-mid-grey">
          ...
          <div className="w-[376px] rounded bg-primary-blue h-11 hidden flex-row items-center justify-center p-2.5 box-border gap-[8px]">
          ...
          <div className="rounded h-11 hidden flex-row items-center justify-center p-2.5 box-border gap-[8px] min-w-[144px]">
            <div className="relative">Share it</div>
            <img className="w-6 relative h-6" alt="" src="/icons-24px.svg" />
          </div>
        </div>
        <div className="w-[288.1px] absolute my-0 mx-[!important] top-[-159px] left-[190.3px] rounded-[50%] [background:linear-gradient(136.23deg,_#027fff,_rgba(83,_2,_255,_0))] [filter:blur(160px)] h-[661.1px] [transform:_rotate(36.4deg)] [transform-origin:0_0] opacity-[0.2] z-[6]" />
      </div>
    </div>
  );
};
