...
const CollectionDetail = () => {
  ...
  const onButtonClick = useCallback(() => {
    navigate("/collection-detail-selected");
  }, [navigate]);

  return (
    <div className="w-full relative bg-main-dark h-[1283px] overflow-hidden">
      <img
        className="absolute top-[0px] left-[0px] w-[1728px] h-[1151.1px]"
        alt=""
        src="/vector.svg"
      />
      <div className="absolute top-[0px] left-[0px] bg-gray1-300 [backdrop-filter:blur(24px)] w-[1728px] h-[1283px]" />
      <main className="absolute top-[64px] left-[calc(50%_-_786px)] rounded-lg bg-main-dark [backdrop-filter:blur(24px)] flex flex-row items-start justify-start p-4 gap-[24px] text-left text-5xl text-light-grey font-h1-title-42 border-[1px] border-solid border-pale-purple">
          ...
          <div className="self-stretch flex flex-col items-start justify-start text-center text-base text-white font-gotham-book">
            <div className="flex flex-col items-start justify-start gap-[8px]">
              ...
              <div className="rounded bg-row overflow-hidden flex flex-row items-center justify-start py-0 pr-5 pl-0">
                ...
                <Button
                  className="min-w-[144px] cursor-pointer"
                  type="default"
        ...
        <div className="rounded bg-row flex flex-col items-center justify-center pt-5 px-6 pb-8 gap-[32px]">
          ...
          <div className="flex flex-col items-start justify-start gap-[16px] text-sm font-gotham-book">
            ...
            <div className="self-stretch flex flex-col items-start justify-start py-6 px-1 gap-[24px] text-base text-mid-grey">
              <div className="self-stretch h-4 flex flex-row items-center justify-start">
          ...
          <div className="w-[241px] relative box-border h-px border-t-[1px] border-solid border-pale-purple" />
          <div className="w-60 flex flex-col items-center justify-start gap-[24px] text-xs text-mid-grey font-medium">
            <div className="self-stretch flex flex-col items-start justify-start py-0 px-1 gap-[16px]">
              <div className="self-stretch flex flex-row items-start justify-between">
                ...
                <div className="relative text-white text-center">--</div>
              </div>
              <div className="self-stretch flex flex-row items-start justify-between">
          ...
          <div className="self-stretch flex flex-col items-center justify-center gap-[24px]">
            <Button className="self-stretch" type="default">{`Lend `}</Button>
            <Button
              className="self-stretch min-w-[144px]"
              type="default"
            >{`Cancel `}</Button>
          </div>
        </div>
